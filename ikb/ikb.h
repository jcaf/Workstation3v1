...
#define iKB_H_
    ...
    //////////////////////////////////////////////////////////////////////////////////////
    ...
    #ifdef iKEY
        #define PORTWxKB_KEY0 		PORTA
        #define PORTRxKB_KEY0 		PINA
        #define CONFIGIOxKB_KEY0 	DDRA
        #define PINxKB_KEY0 		1

		#define PORTWxKB_KEY1 		PORTA
        #define PORTRxKB_KEY1 		PINA
        #define CONFIGIOxKB_KEY1 	DDRA
        #define PINxKB_KEY1 		2

		#define PORTWxKB_KEY2 		PORTA
        #define PORTRxKB_KEY2 		PINA
        #define CONFIGIOxKB_KEY2 	DDRA
        #define PINxKB_KEY2 		3

		#define PORTWxKB_KEY3 		PORTA
        #define PORTRxKB_KEY3 		PINA
        #define CONFIGIOxKB_KEY3 	DDRA
        #define PINxKB_KEY3 		4
		...
		//
		//ikey layout
		#define KB_LYOUT_KEY_X3 0
		#define KB_LYOUT_KEY_A 	1
		#define KB_LYOUT_KEY_B 	2
		#define KB_LYOUT_KEY_C 	3
		#define KB_LYOUT_KEY_P1 4
		#define KB_LYOUT_KEY_P2 5
		//
